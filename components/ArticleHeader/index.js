  ...
  <div>
    ...
    <div className="bg-gray-50 p-3 text-sm text-gray-600">
      <div className="flex flex-col space-y-1">
        <div>Percentage of biased sentences: <span className="font-medium">7.0</span></div>
        <div>Most frequent bias: <span className="font-medium">Political Bias</span></div>
        <div>Average bias strength: <span className="font-medium">0.6</span></div>
        <div>Overall rating: <span className="font-medium">33%</span></div>
      </div>
    </div>
  </div>
);
